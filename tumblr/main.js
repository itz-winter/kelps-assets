!(function (e, t) {
        ...
        return e.JSON && e.JSON.parse
          ...
          : null === n
            ...
            : "string" == typeof n &&
                ((n = ue.trim(n)),
                n &&
                  he.test(n.replace(me, "@").replace(ye, "]").replace(ge, "")))
              ? Function("return " + n)()
    ...
    (ue.ready.promise = function (t) {
      if (!X)
        if (((X = ue.Deferred()), "complete" === Y.readyState))
          ...
          (Y.attachEvent("onreadystatechange", Te),
  ...
  (ue.extend({
    ...
    hasData: function (e) {
      return (
        (e = e.nodeType ? ue.cache[e[ue.expando]] : e[ue.expando]),
        !!e && !s(e)
      );
    },
    data: function (e, t, n) {
